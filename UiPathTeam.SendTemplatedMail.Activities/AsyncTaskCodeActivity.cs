...
{
	/// <summary>
	///     UiPathTeam.SendTemplatedMail AsyncTaskCodeActivity with result <T>
	/// </summary>
	public abstract class AsyncTaskCodeActivity<T> : AsyncCodeActivity, IDisposable
	{
		...
		protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
		{
			...
			var task = ExecuteAsync(context, _cancellationTokenSource.Token, (null as Application));
	...
	/// <summary>
	///     UiPathTeam.SendTemplatedMail AsyncTaskCodeActivity without result
	/// </summary>
